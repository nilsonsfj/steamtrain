...
const FAMILY_SEEDS: readonly FamilySeed[] = [
  ...
  },
  {
    ...
    reference: { provider: "grok", modelId: "grok-4.5" },
    also: {
      cursor: ["cursor-grok-4.5-high", "grok-4.5"],
      opencode: ["opencode/grok-4.5"],
    },
  ...
  },
  {
    ...
    reference: { provider: "grok", modelId: "grok-4.6" },
    classes: ["thinker", "implementer"],
  },
  {
    id: "grok-4.7",
    name: "Grok 4.7",
    aliases: ["grok 4.7", "grok-4.7"],
    reference: { provider: "grok", modelId: "grok-4.7" },
    classes: ["thinker", "ultrathinker", "implementer", "reviewer"],
  },
  {
    id: "grok-4.7-fast",
    name: "Grok 4.7 Fast",
    aliases: ["grok 4.7 fast", "grok-4.7-fast", "grok-4.7-build-fast"],
    reference: { provider: "grok", modelId: "grok-4.7-build-fast" },
    classes: ["implementer", "balanced"],
  },
  {
    id: "cursor-auto",
