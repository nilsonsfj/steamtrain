...
import { KIMI_MODELS, KimiAdapter, buildKimiRunArgs, createKimiMapper } from "../src/agents/kimi";
...
describe("buildKimiRunArgs", () => {
  it("keeps the prompt as the final -p pair and never forwards effort", () => {
